 ...
 * @ClassName:RefreshLayout.java
 * @Package:module.view
 * @time:上午9:14:57 2014-12-2
 * @useage:刷新
 */
public class RefreshLayout extends SwipeRefreshLayout implements OnScrollListener{
     ...
     * 上拉监听器, 到了最底部的上拉加载操作
     */
    private RefreshLoadInterface mOnLoadListener;
     ...
     * @param loadListener
     */
    public void setOnLoadListener(RefreshLoadInterface loadListener) {
